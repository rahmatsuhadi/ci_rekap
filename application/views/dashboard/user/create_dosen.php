...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registrasi Dosen</h1>
                    ...
                    <form method="post" action="#" id="form-course">
                            ...
                            <div class="form-group">
                                <label for="inputIdentity">Nomor Dosen</label>
                                <input type="text" name="identity" class="form-control" id="inputIdentity" aria-describedby="nomorHelp" placeholder="0021126632">
                            </div>
