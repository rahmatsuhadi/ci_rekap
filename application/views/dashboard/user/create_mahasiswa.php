                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="#" id="form-course">
                            <div class="form-group">
                                ...
                                <small id="nameHelp" class="form-text text-muted">Nama mahasiswa yang akan ditampilkan</small>
                            </div>

                            <div class="form-group">
                                <label for="inputIdentity">NIM</label>
                                <input type="text" name="identity" class="form-control" id="inputIdentity" aria-describedby="emailHelp" placeholder="23.01.4968">
                            </div>
