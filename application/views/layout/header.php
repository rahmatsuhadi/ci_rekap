...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=base_url().'dashboard/courses'?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?=base_url().'dashboard/students'?>">Mahasiswa</a>
                        <a class="collapse-item" href="<?=base_url().'dashboard/lecturers'?>">Dosen</a>
                        <a class="collapse-item" href="<?=base_url().'dashboard/users'?>">Admin</a>
                    </div>
                </div>
            </li>
